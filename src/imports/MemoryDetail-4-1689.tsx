import svgPaths from "./svg-jccny3nn7r";
...
function MainPhotoFrame() {
  return (
    <div className="absolute bg-white h-[339.13px] left-1/2 overflow-clip top-[calc(50%-245.43px)] translate-x-[-50%] translate-y-[-50%] w-[234px]" data-name="Main Photo Frame">
      <div className="absolute h-[279.783px] left-[calc(50%-0.42px)] pointer-events-none rounded-[13.565px] top-[calc(50%+0.15px)] translate-x-[-50%] translate-y-[-50%] w-[175.5px]" data-name="Image">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover rounded-[13.565px] size-full" src={imgImage} />
        <div aria-hidden="true" className="absolute border-[4.522px] border-solid border-white inset-[-4.522px] rounded-[18.087px] shadow-[0px_0px_9.043px_0px_rgba(0,0,0,0.25)]" />
      </div>
    </div>
  );
}
...
function Place() {
  return (
    <div className="absolute h-[27px] left-[calc(50%+0.5px)] top-[372px] translate-x-[-50%] w-[53px]" data-name="Place">
